                    =========== Input Reset ===============
Input dengan type reset merupakan input yang akan ditampilkan dalam bentuk tombol.
Jika tombol tersebut ditekan, maka seluruh input dalam form tersebut nilainya akan berubah menjadi nilai default seperti yang terdapat di attribute valuenya.
...
<head>
    ...
    <title>Belajar HTML Form - Input Reset</title>
</head>
<body>
    <h1><b>Belajar HTML Form - Input Reset</b></h1>
    ...
    <form name="registrasi" action="receive.html" method="get">
        ...
        <!--Tag input dengan type=reset (berfungsi untuk mereset nilai yang terdapat di dalam form menjadi nilai defaultnya) value=Reset (value untuk penamaan dari kolom reset tersebut)-->
